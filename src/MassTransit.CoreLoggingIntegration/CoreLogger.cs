...
namespace MassTransit.CoreLoggingIntegration
{
    using Logging;
    using Microsoft.Extensions.Logging;

    public class CoreLogger : Logging.ILogger
    {
        ...
        {
            return new CoreLog(_loggerFactory.CreateLogger(name));
        }
        ...
        public static ILoggerFactory Use(ILoggerFactory loggerFactory = null)
        {
            ...
            Logger.UseLogger(new CoreLogger(loggerFactory));
