...
namespace MassTransit
{
    ...
    public static class CoreLoggingConfiguratorExtensions
    {
        ...
        public static ILoggerFactory UseCoreLogging(this IBusFactoryConfigurator configurator, ILoggerFactory loggerFactory = null)
        {
            ...
            return CoreLoggingIntegration.CoreLogger.Use(loggerFactory);
        }
    }
}